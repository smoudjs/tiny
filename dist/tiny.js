...
Object.assign(Plane.prototype, {
  ...
  setFromCoplanarPoints: function setFromCoplanarPoints(a, b, c) {
    var normal = _vector1.sub2(c, b).cross(Plane_vector2.sub2(a, b)).normalize();
...
Object.assign(Frustum.prototype, {
  ...
  intersectsObject: function intersectsObject(object) {
    var geometry = object.geometry;
    if (geometry.boundingSphere === null) geometry.computeBoundingSphere();
    Frustum_sphere.copy(geometry.boundingSphere).applyMat4(object.matrixWorld);
    return this.intersectsSphere(Frustum_sphere);
  },
  intersectsSprite: function intersectsSprite(sprite) {
    Frustum_sphere.center.set(0, 0, 0);
    Frustum_sphere.radius = 0.7071067811865476;
    Frustum_sphere.applyMat4(sprite.matrixWorld);
    return this.intersectsSphere(Frustum_sphere);
  },
  intersectsSphere: function intersectsSphere(sphere) {
    var planes = this.planes;
