...
import { arrayMax } from '../utils/index.js';
...
Object.assign( Geometry.prototype, {
	...
	computeTangents: function () {
		...
		const tmp = new Vec3(), tmp2 = new Vec3();
		const n = new Vec3(), n2 = new Vec3();
	...
	merge: function ( geometry, offset ) {
		...
		if ( offset === undefined ) {
			...
			console.warn(
				'THREE.Geometry.merge(): Overwriting original geometry, starting at offset=0. '
				+ 'Use GeometryUtils.mergeBufferGeometries() for lossless merge.'
			);
