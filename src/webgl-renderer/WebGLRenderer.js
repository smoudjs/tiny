...
import { WebGLAnimation } from './Animation.js';
import { WebGLAttributes } from './Attributes.js';
import { WebGLBackground } from './Background.js';
import { WebGLBindingStates } from './BindingStates.js';
import { WebGLBufferRenderer } from './BufferRenderer.js';
import { WebGLCapabilities } from './Capabilities.js';
import { WebGLClipping } from './Clipping.js';
// import { WebGLCubeMaps } from './CubeMaps.js';
import { WebGLExtensions } from './Extensions.js';
import { WebGLGeometries } from './Geometries.js';
import { WebGLIndexedBufferRenderer } from './IndexedBufferRenderer.js';
import { WebGLInfo } from './Info.js';
import { WebGLMorphtargets } from './Morphtargets.js';
import { WebGLObjects } from './Objects.js';
import { WebGLPrograms } from './Programs.js';
import { WebGLProperties } from './Properties.js';
import { WebGLRenderLists } from './RenderLists.js';
import { WebGLRenderStates } from './RenderStates.js';
// import { WebGLShadowMap } from './ShadowMap.js';
import { WebGLState } from './State.js';
// import { WebGLRawState } from './RawState.js';
import { WebGLTextures } from './Textures.js';
...
function WebGLRenderer( parameters ) {
	...
	const _currentViewport = new Vec4();
	const _currentScissor = new Vec4();
	let _currentScissorTest = null;

	let _width = parameters.width || 800;
	let _height = parameters.height || 600;

	let _pixelRatio = this.resolution = parameters.resolution || 1;
	let _opaqueSort = null;
	let _transparentSort = null;
	
	const _viewport = new Vec4( 0, 0, _width, _height );
	const _scissor = new Vec4( 0, 0, _width, _height );
	...
	this.render = function ( scene, camera ) {
		...
		const screenObjects = currentRenderList.screen;
	...
	function render2D(displayObject, renderTexture, clear, transform, skipUpdateTransform)
    {
    	...
    	for (let i = 0, l = displayObject.children.length; i < l; i++) {
	...
	function renderObjects( renderList, scene, camera ) {
		...
		const overrideMaterial = null;//scene.isScene === true ? scene.overrideMaterial : null;
