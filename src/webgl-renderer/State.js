...
function WebGLState( gl, extensions, capabilities ) {
	...
	function ColorBuffer() {
		...
		const currentColorClear = new Vec4( 0, 0, 0, 0 );
	...
	const currentScissor = new Vec4( 0, 0, gl.canvas.width, gl.canvas.height );
	const currentViewport = new Vec4( 0, 0, gl.canvas.width, gl.canvas.height );
	...
	function setMaterial( material, frontFaceCW ) {
		...
		( material.blending === NormalBlending && material.transparent === false )
			? setBlending( NoBlending )
			: setBlending( material.blending, material.premultipliedAlpha, material.blendEquation, material.blendSrc, material.blendDst, material.blendEquationAlpha, material.blendSrcAlpha, material.blendDstAlpha );
