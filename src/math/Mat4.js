...
Object.assign(Mat4.prototype, {
	...
	makeRotationFromEuler: function (euler) {
		if (!(euler && euler.isEuler)) {
			console.error(
				'Tiny.Matrix4: .makeRotationFromEuler() now expects a Euler rotation rather than a Vector3 and order.'
			);
		}
	...
	makeRotationFromQuat: function (q) {
	...
	makePerspective: function (left, right, top, bottom, near, far) {
		if (far === undefined) {
			console.warn(
				'Tiny.Matrix4: .makePerspective() has been redefined and has a new signature. Please check the docs.'
			);
		}
