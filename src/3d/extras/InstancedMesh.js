...
export class InstancedMesh extends Mesh {
    constructor(geometry, material, count = 1) {
        if (!geometry.attributes.instancedMatrix) {
            ...
            geometry.attributes.instancedMatrix = new Attribute({ instanced: 1, size: mat4Length, data: instancedMatrix });
        }
    ...
    setMatrixAt(index, matrix) {
        ...
        geometry.attributes.instancedMatrix.set(matrix.elements, index * mat4Length);
    }
